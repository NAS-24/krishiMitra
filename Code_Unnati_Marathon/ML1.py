...
# from storm_glass_test import fetch_api_data1
from storm_glass_test1 import fetch_api_data1

api_data = fetch_api_data()
api_data1= fetch_api_data1()
...
Temperature=api_data1['Temperature']
soil_pH = api_data['pH']

# Load your dataset (replace 'crop_data.csv' with your actual dataset)
data = pd.read_csv(r'C:\Users\naman\Downloads\Crop_recommendation2.csv')
...
X = data[['N','temperature','ph']]  # Add other soil features if you have more
...
new_soil_data = [[nitrogen,Temperature,soil_pH]]  # Example input for moisture, temperature, nitrogen, pH, SOC
